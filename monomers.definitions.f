...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      st_matrix(1,2)= kaibeta
      st_matrix(2,1)= kaibeta
      st_matrix(1,3)= kaiHO 
      st_matrix(3,1)= kaiHO 
      st_matrix(2,3)= 0 
      st_matrix(3,2)= 0
...
! Segment type 3 for NPC, neutral , hydrophilic
      ...
      zpol(3) = 0
      hydroph(3) = 3
      pKa(3) = 7 ! set any number if zpol = 0...

! Segment type 4 for NPC , neutral, hydrophobic, 1

      zpol(4) = 0
      hydroph(4) = 0
      pKa(4) = 7 ! set any number if zpol = 0....
...
! Segment type 5 for NPC = Histidine
      ...
      zpol(5) = 1
      hydroph(5) = 4
      pKa(5) = 11 ! set any number if zpol = 0....

! Segment type 6 for NPC = Cysteamine

      zpol(6) = -1
      hydroph(6) = 4
      pKa(6) = 4 ! set any number if zpol = 0....
